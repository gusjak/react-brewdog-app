...
const ListOfBeers = (props) => {
    return (
        <Link className="transform transition duration-300 hover:scale-105" to={`/beers/${props.beer.id}`}>
            <div className="w-screen max-h-full container mx-auto max-w-sm rounded-lg overflow-hidden shadow-lg py-6 bg-gradient-to-l from-indigo-900 to-purple-800">
                ...
                <div className="flex flex-col justify-center items-center pt-10 text-gray-600 text-center">
                    ...
                    <h2 className="font-bold text-pink-300 tracking-wider text-xl">({props.beer.abv}%)</h2>
