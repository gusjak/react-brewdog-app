...
const SingleBeer = (props) => {
    return (
        <div className="w-full max-h-screen flex flex-col justify-center items-center text-white text-center mt-40 px-4 md:mt-32 md:px-6">
            <img className="h-48 mb-5 lg:h-60" src={props.img} alt="brewdog beer" />
            ...
            <p className="font-normal text-pink-50 tracking-wide px-4 mb-6 md:px-8 lg:px-60">{props.description}</p>
